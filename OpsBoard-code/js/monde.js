...
async function fetchOpenSkyFlights() {
  // OpenSky blocks direct browser requests and the global feed can be too large.
  // Try the local relay first, then a browser-side segmented fallback by world regions.
